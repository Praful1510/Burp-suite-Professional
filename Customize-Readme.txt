...
################################** Execution and Activation **################################
	...
	**1. Place all files in 1 folder**
		...
		For Example lets take as --> C:\Users\Praful\Downloads\burp-suite\

	----------------------------------------------

	**2.1 Run This Command for Windows in CMD Prompt.**

		java --illegal-access=permit -Dfile.encoding=utf-8 -javaagent:"C:\Users\Praful\Downloads\burp-suite\loader.jar" -noverify -jar "C:\Users\Praful\Downloads\burp-suite\burpsuite_pro_v2021.2.1.jar"

	**2.2 Run this command for Linux in Terminal. Suppose Your files are in /home/Praful/Downloads/burp-suite/**

		java --illegal-access=permit -Dfile.encoding=utf-8 -javaagent:/home/Praful/Downloads/burp-suite/loader.jar -noverify -jar /home/Praful/Downloads/burp-suite/burpsuite_pro_v2021.2.1.jar &
	...
	**4. Activate Burp Suite Pro**
		...
		1. Modify License String like "license to Praful"
	...
	**5.1 For Windows Follow These Steps**
		...
		1. Open Notepad and Paste command at 2.1 and save the file with name burp.bat in C:\Users\Praful\Downloads\burp-suite\   Folder.

		2. Open another Notepad and Paste below command and save it with burp.VBS extension in Desktop.

			Set WshShell = CreateObject("WScript.Shell")

			WshShell.Run chr(34) & "C:\Users\Praful\Downloads\burp-suite\burp.bat" & Chr(34), 0
	...
	**5.2 For Linux Follow these Steps**
		...
		2. Paste command in text editor "java --illegal-access=permit -Dfile.encoding=utf-8 -javaagent:/home/Praful/Downloads/burp-suite/loader.jar -noverify -jar /home/Praful/Downloads/burp-suite/burpsuite_pro_v2021.2.1.jar &"
